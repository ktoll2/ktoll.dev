...
**Senior Backend Software Engineer | C#/.NET | APIs, Distributed Systems & Architecture**

Vancouver, Washington, United States · [Email: kirk@ktoll.dev](mailto:kirk@ktoll.dev) · [LinkedIn: /in/ktolleshaug](https://www.linkedin.com/in/ktolleshaug) · [Website: ktoll.dev](https://ktoll.dev)
...
- Modernize legacy services from .NET Framework 4.x and .NET Core 3 to modern .NET, and containerize local dependencies with Docker Compose to improve CI/CD reliability and cross-team development compatibility.
- Use AI-assisted engineering tools to analyze unfamiliar code paths, accelerate legacy refactoring and modernization, investigate defects, and review changes, with developer-owned validation through tests and code review.
- Apply AI-assisted analysis to logs and traces, dependency mapping, API and schema compatibility reviews, test-case generation, and drafting technical documentation, migration plans, and release notes.
...
- Develop React-based user interfaces and application workflows supporting backend services and operational needs.
...
**Relevant Skills:** C# in .NET, Microsoft Azure, Angular, Microsoft SQL Server, OAuth, Infrastructure as code (IaC), Continuous Integration and Continuous Delivery (CI/CD), Test-Driven Development
...
- Developed C#/.NET applications and backend services across multiple generations of .NET, with Angular front ends and SQL Server data stores; designed Entity Framework migrations for greenfield Azure applications and contributed to Flyway-based legacy migrations.
...
- Built Azure-hosted applications using App Services, Azure SQL, Key Vault, Functions, Pulumi, and early Bicep.
...
- Designed and delivered a reporting system combining multiple domains and schemas, performing extensive customer-specific transformations and processing datasets containing millions of records.
...
**Relevant Skills:** C (Programming Language), Linux, Classroom Instruction, Mentoring, Java, Public Speaking

- Assisted faculty with instructional delivery for Computer Science I, II, III, C and Unix, and Logic Fundamentals courses.
- Provided one-on-one support for programming concepts, debugging, coursework, and technical problem solving.
- Supported course operations by grading assignments and coursework, providing feedback to students, and assisting with exam proctoring.
...
**Relevant Skills:** C# in .NET, ASP.NET, Microsoft SQL Server, Entity Framework, Internet Information Services (IIS), Moodle, HTML/CSS

- Designed and implemented ASP.NET/C# web applications for university departments using SQL Server, Entity Framework, and IIS.
- Designed and built an end-to-end sign-in and usage-tracking application supporting the university writing lab.
...
**Southeast Missouri State University**  
Bachelor of Science - BS, General Studies · 2011 - 2015
